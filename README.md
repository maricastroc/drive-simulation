...
| **🗺️ Pick your scale**       | Swap the whole grid in one click — a **3×3 toy up to a 12×12 metro** (144 junctions) — same seed, same engine, so you read how scale _alone_ bends the flow.                                                                 |
